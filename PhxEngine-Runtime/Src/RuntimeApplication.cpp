...
class PhxEngineRuntimeApp : public IEngineApplication
{
private:

public:
    PhxEngineRuntimeApp() = default;
    ...
    bool Initialize() override
    {
        ...
        // Construct a simple scene for testing.
        
        // Construct a cube for drawing
        MeshDesc desc = {};


        // IRenderService::Impl->CreateDrawable()
        return true;
    }
