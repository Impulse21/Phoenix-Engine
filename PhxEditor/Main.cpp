...
>>>>>>> c44c559ccb372caf73938f28953663abf1e0a85f
}
#endif
...
<<<<<<< HEAD
LPCWSTR g_szAppName = L"Phx Editor (Dx12)";
=======
LPCWSTR g_szAppName = L"PhxEditor_WindowsDx12";
>>>>>>> c44c559ccb372caf73938f28953663abf1e0a85f
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"PhxEditor_WindowsDx12WindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"PhxEditor_WindowsDx12WindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top,
            nullptr, nullptr, hInstance,
            g_game.get());
        // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"PhxEditor_WindowsDx12WindowClass", g_szAppName, WS_POPUP,
