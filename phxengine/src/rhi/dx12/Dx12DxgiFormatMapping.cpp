...
static const DxgiFormatMapping c_FormatMappings[] = {
  ...
  /*
  { Format::D32,                  DXGI_FORMAT_R32_TYPELESS,           DXGI_FORMAT_R32_UINT,                 DXGI_FORMAT_D32_FLOAT              },
  */
...
const DxgiFormatMapping& phx::rhi::dx12::GetDxgiFormatMapping(Format abstractFormat)
{
