...
namespace PhxEngine::RHI::Dx12
{
	...
	*/
	...
	public:
		...
		void SetIsBindless(bool isBindless) { this->m_isBindless = isBindless; }
		bool IsBindless() const { return this->m_isBindless; }
	...
	class RootSignatureBuilder : public IRootSignatureBuilder
	{
	public:
