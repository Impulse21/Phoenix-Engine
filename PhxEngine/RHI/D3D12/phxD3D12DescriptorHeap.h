...
namespace phx::rhi::d3d12
{
	...
	class CpuDescriptorHeap : public IDescriptorAllocator, NonCopyable, NonMoveable
	{
	public:
		void Initialize(
	...
	class GpuDescriptorHeap : public IDescriptorAllocator, NonCopyable, NonMoveable
	{
	public:
		void Initialize(
			D3D12GfxDevice* device,
