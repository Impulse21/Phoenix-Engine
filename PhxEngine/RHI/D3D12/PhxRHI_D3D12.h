...
namespace phx::rhi::d3d12
{
    ...
    {
    public:
        D3D12GfxDevice(InitDesc const& initDesc);
        ~D3D12GfxDevice();
    ...
    public:
        ...
        size_t GetFrameIndex() const override { return this->GetBackBufferIndex(); };
        size_t GetMaxInflightFrames() const override { return this->m_swapChain.Desc.BufferCount; }
        const DeviceCapabilities& GetDeviceCapability() const override { return this->m_capabilities; }
    ...
    public:
        RenderFrame BeginRenderFrame() override;
