...
#include "phxD3D12BiindlessDescriptorTable.h"
...
namespace
{
	...
	constexpr D3D12_SUBRESOURCE_DATA _ConvertSubresourceData(const rhi::SubresourceData& pInitialData)
	{
...
void D3D12GfxDevice::Initialize(SwapChainDesc const& swapchainDesc, void* windowHandle)
{
...
void D3D12GfxDevice::SubmitFrame()
{
	// Submit Commandlists
...
bool D3D12GfxDevice::IsHdrSwapchainSupported()
{
...
CommandSignatureHandle D3D12GfxDevice::CreateCommandSignature(CommandSignatureDesc const& desc, size_t byteStride)
{
...
void D3D12GfxDevice::DeleteCommandSignature(CommandSignatureHandle handle)
{
	if (!handle.IsValid())
	{
		return;
...
ShaderHandle D3D12GfxDevice::CreateShader(ShaderDesc const& desc, Span<uint8_t> shaderByteCode)
{
...
InputLayoutHandle D3D12GfxDevice::CreateInputLayout(VertexAttributeDesc* desc, uint32_t attributeCount)
{
...
GfxPipelineHandle D3D12GfxDevice::CreateGfxPipeline(GfxPipelineDesc const& desc)
{
...
ComputePipelineHandle D3D12GfxDevice::CreateComputePipeline(ComputePipelineDesc const& desc)
{
...
MeshPipelineHandle D3D12GfxDevice::CreateMeshPipeline(MeshPipelineDesc const& desc)
{
...
RenderPassHandle D3D12GfxDevice::CreateRenderPass(RenderPassDesc const& desc)
{
...
void D3D12GfxDevice::GetRenderPassFormats(RenderPassHandle handle, std::vector<rhi::Format>& outRtvFormats, rhi::Format& depthFormat)
{
...
rhi::RenderPassDesc D3D12GfxDevice::GetRenderPassDesc(RenderPassHandle handle)
{
	D3D12RenderPass* renderPass = this->GetRenderPassPool().Get(handle);
	return renderPass->Desc;
}

void D3D12GfxDevice::DeleteRenderPass(RenderPassHandle handle)
{
	if (!handle.IsValid())
	{
		return;
...
TextureHandle D3D12GfxDevice::CreateTexture(TextureDesc const& desc)
{
...
const TextureDesc& D3D12GfxDevice::GetTextureDesc(TextureHandle handle)
{
	const D3D12Texture* texture = this->m_texturePool.Get(handle);
	return texture->Desc;
}

DescriptorIndex D3D12GfxDevice::GetDescriptorIndex(TextureHandle handle, SubresouceType type, int subResource)
{
	const D3D12Texture* texture = this->m_texturePool.Get(handle);
...
void D3D12GfxDevice::DeleteTexture(TextureHandle handle)
{
	if (!handle.IsValid())
	{
		return;
...
BufferHandle D3D12GfxDevice::CreateBuffer(BufferDesc const& desc)
{
...
RTAccelerationStructureHandle D3D12GfxDevice::CreateRTAccelerationStructure(RTAccelerationStructureDesc const& desc)
{
...
const RTAccelerationStructureDesc& D3D12GfxDevice::GetRTAccelerationStructureDesc(RTAccelerationStructureHandle handle)
{
	assert(handle.IsValid());
	return this->m_rtAccelerationStructurePool.Get(handle)->Desc;
}

void D3D12GfxDevice::WriteRTTopLevelAccelerationStructureInstance(RTAccelerationStructureDesc::TopLevelDesc::Instance const& instance, void* dest)
{
...
size_t D3D12GfxDevice::GetRTTopLevelAccelerationStructureInstanceSize()
{
	return sizeof(D3D12_RAYTRACING_INSTANCE_DESC);
}

void D3D12GfxDevice::DeleteRtAccelerationStructure(RTAccelerationStructureHandle handle)
{
	if (!handle.IsValid())
	{
		return;
...
DescriptorIndex D3D12GfxDevice::GetDescriptorIndex(RTAccelerationStructureHandle handle)
{
...
int D3D12GfxDevice::CreateSubresource(TextureHandle texture, SubresouceType subresourceType, uint32_t firstSlice, uint32_t sliceCount, uint32_t firstMip, uint32_t mipCount)
{
...
int D3D12GfxDevice::CreateSubresource(BufferHandle buffer, SubresouceType subresourceType, size_t offset, size_t size)
{
	switch (subresourceType)
	{
	case SubresouceType::SRV:
...
TimerQueryHandle D3D12GfxDevice::CreateTimerQuery()
{
...
void D3D12GfxDevice::DeleteTimerQuery(TimerQueryHandle query)
{
	if (!query.IsValid())
	{
		return;
...
bool D3D12GfxDevice::PollTimerQuery(TimerQueryHandle query)
{
...
TimeStep D3D12GfxDevice::GetTimerQueryTime(TimerQueryHandle query)
{
	assert(query.IsValid());
	D3D12TimerQuery* queryImpl = this->m_timerQueryPool.Get(query);
...
void D3D12GfxDevice::ResetTimerQuery(TimerQueryHandle query)
{
	assert(query.IsValid());
	D3D12TimerQuery* queryImpl = this->m_timerQueryPool.Get(query);
...
inline TextureHandle  D3D12GfxDevice::D3D12GfxDevice::GetBackBuffer()
{
	return this->m_swapChain.BackBuffers[this->GetBackBufferIndex()];
}

size_t D3D12GfxDevice::GetBackBufferIndex() const
{
	auto retVal = this->m_swapChain.NativeSwapchain4->GetCurrentBackBufferIndex();
	return (size_t)retVal;
}

void D3D12GfxDevice::BeginCapture(std::wstring const& filename)
{
#if ENABLE_PIX_CAPUTRE
...
void D3D12GfxDevice::EndCapture(bool discard)
{
#if ENABLE_PIX_CAPUTRE
	if (this->m_pixCaptureModule)
	{
...
bool D3D12GfxDevice::CheckCapability(DeviceCapability deviceCapability)
{
	return (this->m_capabilities & deviceCapability) == deviceCapability;
}

float D3D12GfxDevice::GetAvgFrameTime()
{
	return 0.0f;
}

bool D3D12GfxDevice::IsDevicedRemoved()
{
	HRESULT hr = this->GetD3D12Device5()->GetDeviceRemovedReason();
	return FAILED(hr);
}

void D3D12GfxDevice::DeleteD3DResource(Microsoft::WRL::ComPtr<ID3D12Resource> resource)
{
	DeleteItem d =
	{
		this->m_frameCount,
...
TextureHandle D3D12GfxDevice::CreateRenderTarget(
...
TextureHandle D3D12GfxDevice::CreateTexture(TextureDesc const& desc, Microsoft::WRL::ComPtr<ID3D12Resource> d3d12Resource)
{
	// Construct Texture
	D3D12Texture texture = {};
	texture.Desc = desc;
...
int D3D12GfxDevice::CreateShaderResourceView(TextureHandle texture, uint32_t firstSlice, uint32_t sliceCount, uint32_t firstMip, uint32_t mipCount)
{
...
void D3D12GfxDevice::RunGarbageCollection(uint64_t completedFrame)
{
...
void D3D12GfxDevice::TranslateBlendState(BlendRenderState const& inState, D3D12_BLEND_DESC& outState)
{
...
void D3D12GfxDevice::TranslateDepthStencilState(DepthStencilRenderState const& inState, D3D12_DEPTH_STENCIL_DESC& outState)
{
...
void D3D12GfxDevice::TranslateRasterState(RasterRenderState const& inState, D3D12_RASTERIZER_DESC& outState)
{
...
int D3D12GfxDevice::CreateShaderResourceView(BufferHandle buffer, size_t offset, size_t size)
{
	D3D12Buffer* bufferImpl = this->m_bufferPool.Get(buffer);
...
void D3D12GfxDevice::InitializeResourcePools()
{
...
void D3D12GfxDevice::InitializeD3D12NativeResources(IDXGIAdapter* gpuAdapter)
{
...
void D3D12GfxDevice::CreateSwapChain(SwapChainDesc const& desc, void* windowHandle)
{
...
void D3D12GfxDevice::FindAdapter(Microsoft::WRL::ComPtr<IDXGIFactory6> factory, D3D12Adapter& outAdapter)
{
...
void D3D12GfxDevice::RTBuildAccelerationStructure(rhi::RTAccelerationStructureHandle accelStructure, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::TransitionBarriers(Span<GpuBarrier> gpuBarriers, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::ExecuteIndirect(rhi::CommandSignatureHandle commandSignature, rhi::BufferHandle args, size_t argsOffsetInBytes, uint32_t maxCount, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::ExecuteIndirect(
...
void D3D12GfxDevice::DrawIndirect(rhi::BufferHandle args, size_t argsOffsetInBytes, uint32_t maxCount, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
	D3D12Buffer* bufferImpl = this->GetBufferPool().Get(args);
	internalCmd.NativeCommandList6->ExecuteIndirect(
...
void D3D12GfxDevice::DrawIndexedIndirect(rhi::BufferHandle args, size_t argsOffsetInBytes, uint32_t maxCount, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
	D3D12Buffer* bufferImpl = this->GetBufferPool().Get(args);
	internalCmd.NativeCommandList6->ExecuteIndirect(
...
void D3D12GfxDevice::WriteTexture(TextureHandle texture, uint32_t firstSubresource, size_t numSubresources, SubresourceData* pSubresourceData, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
	auto textureImpl = this->GetTexturePool().Get(texture);
...
void D3D12GfxDevice::SetGfxPipeline(GfxPipelineHandle graphicsPiplineHandle, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::SetViewports(Viewport* viewports, size_t numViewports, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::SetScissors(Rect* scissors, size_t numScissors, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::BindPushConstant(uint32_t rootParameterIndex, uint32_t sizeInBytes, const void* constants, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::BindConstantBuffer(size_t rootParameterIndex, BufferHandle constantBuffer, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::BindDynamicConstantBuffer(size_t rootParameterIndex, size_t sizeInBytes, const void* bufferData, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::BindVertexBuffer(uint32_t slot, BufferHandle vertexBuffer, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::BindDynamicVertexBuffer(uint32_t slot, size_t numVertices, size_t vertexSize, const void* vertexBufferData, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::BindIndexBuffer(BufferHandle indexBuffer, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::BindDynamicIndexBuffer(size_t numIndicies, rhi::Format indexFormat, const void* indexBufferData, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::BindDynamicStructuredBuffer(uint32_t rootParameterIndex, size_t numElements, size_t elementSize, const void* bufferData, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::BindStructuredBuffer(size_t rootParameterIndex, BufferHandle buffer, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
	const D3D12Buffer* bufferImpl = this->GetBufferPool().Get(buffer);
...
void D3D12GfxDevice::BindResourceTable(size_t rootParameterIndex, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::BindDynamicUavDescriptorTable(
...
void D3D12GfxDevice::SetComputeState(ComputePipelineHandle state, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::Dispatch(uint32_t groupsX, uint32_t groupsY, uint32_t groupsZ, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
	internalCmd.NativeCommandList->Dispatch(groupsX, groupsY, groupsZ);
}

void D3D12GfxDevice::DispatchIndirect(rhi::BufferHandle args, uint32_t argsOffsetInBytes, uint32_t maxCount, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
	D3D12Buffer* bufferImpl = this->GetBufferPool().Get(args);
	internalCmd.NativeCommandList6->ExecuteIndirect(
...
void D3D12GfxDevice::SetMeshPipeline(MeshPipelineHandle meshPipeline, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::DispatchMesh(uint32_t groupsX, uint32_t groupsY, uint32_t groupsZ, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
...
void D3D12GfxDevice::DispatchMeshIndirect(rhi::BufferHandle args, uint32_t argsOffsetInBytes, uint32_t maxCount, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
	D3D12Buffer* bufferImpl = this->GetBufferPool().Get(args);
	internalCmd.NativeCommandList6->ExecuteIndirect(
...
void D3D12GfxDevice::BeginTimerQuery(TimerQueryHandle query, CommandListHandle cmd)
{
	assert(query.IsValid());
	D3D12CommandList& internalCmd = this->m_commandListPool[cmd];
