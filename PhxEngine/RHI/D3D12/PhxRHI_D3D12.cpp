...
#include "D3D12TypeTranslations.h"
#include "RHI/IDeviceNotify.h"
...
void Context::Initialize(RHIDesc const& desc)
{
    Context::Desc = desc;
...
bool phx::rhi::d3d12::D3D12Context::ResizeSwapchain(int width, int height)
{
    if (!Context::Window)
        return false;
...
void phx::rhi::d3d12::D3D12Context::RegisterDeviceNotify(IDeviceNotify* deviceNotify)
{
}

void phx::rhi::d3d12::D3D12Context::WaitForGpu()
{
}

void phx::rhi::d3d12::D3D12Context::Finalize()
{
}
