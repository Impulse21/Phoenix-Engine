...
{
	class D3D12BindlessDescriptorTable final : NonCopyable, NonMoveable
	{
	public:

		void Initialize(D3D12DescriptorAllocation&& allocation)
		{
	...
	private:
		D3D12DescriptorAllocation m_allocation;
