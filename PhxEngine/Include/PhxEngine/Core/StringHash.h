...
namespace PhxEngine
{
	...
	public:
		...
		bool operator==(const StringHash& other) const { return other.m_computedHash == this->m_computedHash; }
...
{
	template <>
	struct hash<PhxEngine::StringHash>
	{
		size_t operator()(PhxEngine::StringHash const& obj) const
		{
