...
DirectX::XMFLOAT3 PhxEngine::Scene::TransformComponent::GetPosition() const
{
	return *((XMFLOAT3*)&this->WorldMatrix._41);
}

DirectX::XMFLOAT4 PhxEngine::Scene::TransformComponent::GetRotation() const
{
	XMFLOAT4 rotation;
...
DirectX::XMFLOAT3 PhxEngine::Scene::TransformComponent::GetScale() const
{
	XMFLOAT3 scale;
...
DirectX::XMVECTOR PhxEngine::Scene::TransformComponent::GetPositionV() const
{
	return XMLoadFloat3((XMFLOAT3*)&this->WorldMatrix._41);
}

DirectX::XMVECTOR PhxEngine::Scene::TransformComponent::GetRotationV() const
{
	XMVECTOR S, R, T;
...
DirectX::XMVECTOR PhxEngine::Scene::TransformComponent::GetScaleV() const
{
	XMVECTOR S, R, T;
	XMMatrixDecompose(&S, &R, &T, XMLoadFloat4x4(&this->WorldMatrix));
	return S;
...
XMMATRIX PhxEngine::Scene::TransformComponent::GetLocalMatrix() const
{
...
void PhxEngine::Scene::TransformComponent::UpdateTransform()
{
	if (this->IsDirty())
	{
		this->SetDirty(false);
...
void PhxEngine::Scene::TransformComponent::UpdateTransform(TransformComponent const& parent)
{
...
void PhxEngine::Scene::TransformComponent::ApplyTransform()
{
	this->SetDirty();
...
void PhxEngine::Scene::TransformComponent::ClearTransform()
{
	this->SetDirty();
...
void PhxEngine::Scene::TransformComponent::Translate(const XMFLOAT3& value)
{
	this->SetDirty();
...
void PhxEngine::Scene::TransformComponent::Translate(DirectX::XMVECTOR const& value)
{
...
void PhxEngine::Scene::MeshComponent::CreateRenderData(
...
void PhxEngine::Scene::CameraComponent::TransformCamera(TransformComponent const& transform)
{
...
uint32_t PhxEngine::Scene::MaterialComponent::GetRenderTypes()
{
	if (this->BlendMode == Graphics::BlendMode::Opaque)
	{
		return Graphics::RenderType_Opaque;
	}

	return Graphics::RenderType_Transparent;
}
