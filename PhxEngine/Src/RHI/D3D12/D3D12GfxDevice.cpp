...
bool PhxEngine::RHI::D3D12::D3D12GfxDevice::IsHdrSwapchainSupported()
{
...
CommandSignatureHandle PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateCommandSignature(CommandSignatureDesc const& desc, size_t byteStride)
{
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::DeleteCommandSignature(CommandSignatureHandle handle)
{
	if (!handle.IsValid())
	{
		return;
...
InputLayoutHandle PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateInputLayout(VertexAttributeDesc* desc, uint32_t attributeCount)
{
...
GfxPipelineHandle PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateGfxPipeline(GfxPipelineDesc const& desc)
{
...
const GfxPipelineDesc& PhxEngine::RHI::D3D12::D3D12GfxDevice::GetGfxPipelineDesc(GfxPipelineHandle handle)
{
	return this->m_gfxPipelinePool.Get(handle)->Desc;
}

void PhxEngine::RHI::D3D12::D3D12GfxDevice::DeleteGfxPipeline(GfxPipelineHandle handle)
{
	if (!handle.IsValid())
	{
		return;
...
ComputePipelineHandle PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateComputePipeline(ComputePipelineDesc const& desc)
{
...
MeshPipelineHandle PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateMeshPipeline(MeshPipelineDesc const& desc)
{
...
RenderPassHandle PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateRenderPass(RenderPassDesc const& desc)
{
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::GetRenderPassFormats(RenderPassHandle handle, std::vector<RHI::Format>& outRtvFormats, RHI::Format& depthFormat)
{
	...
	{
		RHI::Format format = this->GetTextureDesc(attachment.Texture).Format;
...
RenderPassDesc PhxEngine::RHI::D3D12::D3D12GfxDevice::GetRenderPassDesc(RenderPassHandle handle)
{
	D3D12RenderPass* renderPass = this->GetRenderPassPool().Get(handle);
	return renderPass->Desc;
}

void PhxEngine::RHI::D3D12::D3D12GfxDevice::DeleteRenderPass(RenderPassHandle handle)
{
	if (!handle.IsValid())
	{
		return;
...
const TextureDesc& PhxEngine::RHI::D3D12::D3D12GfxDevice::GetTextureDesc(TextureHandle handle)
{
	const D3D12Texture* texture = this->m_texturePool.Get(handle);
	return texture->Desc;
}

DescriptorIndex PhxEngine::RHI::D3D12::D3D12GfxDevice::GetDescriptorIndex(TextureHandle handle, SubresouceType type, int subResource)
{
	const D3D12Texture* texture = this->m_texturePool.Get(handle);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::DeleteTexture(TextureHandle handle)
{
	if (!handle.IsValid())
	{
		return;
...
RTAccelerationStructureHandle PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateRTAccelerationStructure(RTAccelerationStructureDesc const& desc)
{
...
const RTAccelerationStructureDesc& PhxEngine::RHI::D3D12::D3D12GfxDevice::GetRTAccelerationStructureDesc(RTAccelerationStructureHandle handle)
{
	assert(handle.IsValid());
	return this->m_rtAccelerationStructurePool.Get(handle)->Desc;
}

void PhxEngine::RHI::D3D12::D3D12GfxDevice::WriteRTTopLevelAccelerationStructureInstance(RTAccelerationStructureDesc::TopLevelDesc::Instance const& instance, void* dest)
{
...
size_t PhxEngine::RHI::D3D12::D3D12GfxDevice::GetRTTopLevelAccelerationStructureInstanceSize()
{
	return sizeof(D3D12_RAYTRACING_INSTANCE_DESC);
}

void PhxEngine::RHI::D3D12::D3D12GfxDevice::DeleteRtAccelerationStructure(RTAccelerationStructureHandle handle)
{
	if (!handle.IsValid())
	{
		return;
...
DescriptorIndex PhxEngine::RHI::D3D12::D3D12GfxDevice::GetDescriptorIndex(RTAccelerationStructureHandle handle)
{
...
int PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateSubresource(TextureHandle texture, SubresouceType subresourceType, uint32_t firstSlice, uint32_t sliceCount, uint32_t firstMip, uint32_t mipCount)
{
...
int PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateSubresource(BufferHandle buffer, SubresouceType subresourceType, size_t offset, size_t size)
{
	switch (subresourceType)
	{
	case SubresouceType::SRV:
...
TimerQueryHandle PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateTimerQuery()
{
...
bool PhxEngine::RHI::D3D12::D3D12GfxDevice::PollTimerQuery(TimerQueryHandle query)
{
...
TimeStep PhxEngine::RHI::D3D12::D3D12GfxDevice::GetTimerQueryTime(TimerQueryHandle query)
{
	assert(query.IsValid());
	D3D12TimerQuery* queryImpl = this->m_timerQueryPool.Get(query);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::ResetTimerQuery(TimerQueryHandle query)
{
	assert(query.IsValid());
	D3D12TimerQuery* queryImpl = this->m_timerQueryPool.Get(query);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::EndCapture(bool discard)
{
#if ENABLE_PIX_CAPUTRE
	if (this->m_pixCaptureModule)
	{
...
bool PhxEngine::RHI::D3D12::D3D12GfxDevice::CheckCapability(DeviceCapability deviceCapability)
{
	return (this->m_capabilities & deviceCapability) == deviceCapability;
}

float PhxEngine::RHI::D3D12::D3D12GfxDevice::GetAvgFrameTime()
{
	return 0.0f;
}

bool PhxEngine::RHI::D3D12::D3D12GfxDevice::IsDevicedRemoved()
{
	HRESULT hr =  this->GetD3D12Device5()->GetDeviceRemovedReason();
	return FAILED(hr);
}

void PhxEngine::RHI::D3D12::D3D12GfxDevice::DeleteD3DResource(Microsoft::WRL::ComPtr<ID3D12Resource> resource)
{
	DeleteItem d =
	{
		this->m_frameCount,
...
TextureHandle PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateRenderTarget(
...
TextureHandle PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateTexture(TextureDesc const& desc, Microsoft::WRL::ComPtr<ID3D12Resource> d3d12Resource)
{
	// Construct Texture
	D3D12Texture texture = {};
	texture.Desc = desc;
...
int PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateShaderResourceView(TextureHandle texture, uint32_t firstSlice, uint32_t sliceCount, uint32_t firstMip, uint32_t mipCount)
{
...
int PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateRenderTargetView(TextureHandle texture, uint32_t firstSlice, uint32_t sliceCount, uint32_t firstMip, uint32_t mipCount)
{
	D3D12Texture* textureImpl = this->m_texturePool.Get(texture);
...
int PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateDepthStencilView(TextureHandle texture, uint32_t firstSlice, uint32_t sliceCount, uint32_t firstMip, uint32_t mipCount)
{
	D3D12Texture* textureImpl = this->m_texturePool.Get(texture);
...
int PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateUnorderedAccessView(TextureHandle texture, uint32_t firstSlice, uint32_t sliceCount, uint32_t firstMip, uint32_t mipCount)
{
	D3D12Texture* textureImpl = this->m_texturePool.Get(texture);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::TranslateBlendState(BlendRenderState const& inState, D3D12_BLEND_DESC& outState)
{
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::TranslateDepthStencilState(DepthStencilRenderState const& inState, D3D12_DEPTH_STENCIL_DESC& outState)
{
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::TranslateRasterState(RasterRenderState const& inState, D3D12_RASTERIZER_DESC& outState)
{
...
int PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateShaderResourceView(BufferHandle buffer, size_t offset, size_t size)
{
	D3D12Buffer* bufferImpl = this->m_bufferPool.Get(buffer);
...
int PhxEngine::RHI::D3D12::D3D12GfxDevice::CreateUnorderedAccessView(BufferHandle buffer, size_t offset, size_t size)
{
	D3D12Buffer* bufferImpl = this->m_bufferPool.Get(buffer);
...
CommandListHandle PhxEngine::RHI::D3D12::D3D12GfxDevice::BeginCommandList(CommandQueueType queueType)
{
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::WaitCommandList(CommandListHandle cmd, CommandListHandle waitOn)
{
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::RTBuildAccelerationStructure(RHI::RTAccelerationStructureHandle accelStructure, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::TransitionBarrier(
	BufferHandle buffer,
	ResourceStates beforeState,
	ResourceStates afterState,
	CommandListHandle cmd)
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::ExecuteIndirect(RHI::CommandSignatureHandle commandSignature, RHI::BufferHandle args, size_t argsOffsetInBytes, uint32_t maxCount, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::ExecuteIndirect(
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::DrawIndirect(RHI::BufferHandle args, size_t argsOffsetInBytes, uint32_t maxCount, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
	D3D12Buffer* bufferImpl = this->GetBufferPool().Get(args);
	internalCmd.NativeCommandList6->ExecuteIndirect(
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::DrawIndirect(RHI::BufferHandle args, size_t argsOffsetInBytes, RHI::BufferHandle count, size_t countOffsetInBytes, uint32_t maxCount, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
	D3D12Buffer* argBufferImpl = this->GetBufferPool().Get(args);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::DrawIndexedIndirect(RHI::BufferHandle args, size_t argsOffsetInBytes, uint32_t maxCount, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
	D3D12Buffer* bufferImpl = this->GetBufferPool().Get(args);
	internalCmd.NativeCommandList6->ExecuteIndirect(
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::DrawIndexedIndirect(RHI::BufferHandle args, size_t argsOffsetInBytes, RHI::BufferHandle count, size_t countOffsetInBytes, uint32_t maxCount, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
	D3D12Buffer* argBufferImpl = this->GetBufferPool().Get(args);
	D3D12Buffer* countBufferBufferImpl = this->GetBufferPool().Get(args);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::WriteTexture(TextureHandle texture, uint32_t firstSubresource, size_t numSubresources, SubresourceData* pSubresourceData, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
	auto textureImpl = this->GetTexturePool().Get(texture);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::WriteTexture(TextureHandle texture, uint32_t arraySlice, uint32_t mipLevel, const void* Data, size_t rowPitch, size_t depthPitch, CommandListHandle cmd)
{
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::SetGfxPipeline(GfxPipelineHandle graphicsPiplineHandle, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::SetViewports(Viewport* viewports, size_t numViewports, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::SetScissors(Rect* scissors, size_t numScissors, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::BindPushConstant(uint32_t rootParameterIndex, uint32_t sizeInBytes, const void* constants, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::BindConstantBuffer(size_t rootParameterIndex, BufferHandle constantBuffer, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::BindVertexBuffer(uint32_t slot, BufferHandle vertexBuffer, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::BindDynamicVertexBuffer(uint32_t slot, size_t numVertices, size_t vertexSize, const void* vertexBufferData, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::BindIndexBuffer(BufferHandle indexBuffer, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::BindDynamicIndexBuffer(size_t numIndicies, RHI::Format indexFormat, const void* indexBufferData, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::BindDynamicStructuredBuffer(uint32_t rootParameterIndex, size_t numElements, size_t elementSize, const void* bufferData, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::BindStructuredBuffer(size_t rootParameterIndex, BufferHandle buffer, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
	const D3D12Buffer* bufferImpl = this->GetBufferPool().Get(buffer);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::BindResourceTable(size_t rootParameterIndex, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::BindSamplerTable(size_t rootParameterIndex, CommandListHandle cmd)
{
	// TODO:
	assert(false);
}
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::SetComputeState(ComputePipelineHandle state, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::Dispatch(uint32_t groupsX, uint32_t groupsY, uint32_t groupsZ, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
	internalCmd.NativeCommandList->Dispatch(groupsX, groupsY, groupsZ);
}

void PhxEngine::RHI::D3D12::D3D12GfxDevice::DispatchIndirect(RHI::BufferHandle args, uint32_t argsOffsetInBytes, uint32_t maxCount, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
	D3D12Buffer* bufferImpl = this->GetBufferPool().Get(args);
	internalCmd.NativeCommandList6->ExecuteIndirect(
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::DispatchIndirect(RHI::BufferHandle args, uint32_t argsOffsetInBytes, RHI::BufferHandle count, size_t countOffsetInBytes, uint32_t maxCount, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
	D3D12Buffer* argBufferImpl = this->GetBufferPool().Get(args);
	D3D12Buffer* countBufferBufferImpl = this->GetBufferPool().Get(args);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::SetMeshPipeline(MeshPipelineHandle meshPipeline, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::DispatchMesh(uint32_t groupsX, uint32_t groupsY, uint32_t groupsZ, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::DispatchMeshIndirect(RHI::BufferHandle args, uint32_t argsOffsetInBytes, uint32_t maxCount, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
	D3D12Buffer* bufferImpl = this->GetBufferPool().Get(args);
	internalCmd.NativeCommandList6->ExecuteIndirect(
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::DispatchMeshIndirect(RHI::BufferHandle args, uint32_t argsOffsetInBytes, RHI::BufferHandle count, size_t countOffsetInBytes, uint32_t maxCount, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
	D3D12Buffer* argBufferImpl = this->GetBufferPool().Get(args);
	D3D12Buffer* countBufferBufferImpl = this->GetBufferPool().Get(args);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::BeginTimerQuery(TimerQueryHandle query, CommandListHandle cmd)
{
	assert(query.IsValid());
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
...
void PhxEngine::RHI::D3D12::D3D12GfxDevice::EndTimerQuery(TimerQueryHandle query, CommandListHandle cmd)
{
	D3D12CommandList& internalCmd = *this->m_commandListPool.Get(cmd);
	D3D12TimerQuery* queryImpl = this->GetTimerQueryPool().Get(query);
