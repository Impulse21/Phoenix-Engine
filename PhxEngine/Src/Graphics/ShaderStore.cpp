...
void ShaderStore::PreloadShaders(ShaderFactory& shaderFactory)
{
	...
	this->m_shaderHandles[static_cast<size_t>(PreLoadShaders::PS_DeferredLighting_RTShadows)] = shaderFactory.LoadShader(ShaderStage::Pixel, "DeferredLighting_RTShadowsPS.cso");
	...
	this->m_shaderHandles[static_cast<size_t>(PreLoadShaders::PS_SkyTexture)] = shaderFactory.LoadShader(ShaderStage::Pixel, "Sky_TexturePS.cso");
