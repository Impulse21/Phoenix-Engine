...
project(project_name_phx_engine)
	...
	files
	{
		engine_include_directory..'/*',
		engine_include_directory..'/core/*',
		engine_include_directory..'/renderer/*',
		engine_include_directory..'/rhi/*',
		engine_src_directory..'/*',
		engine_src_directory..'/core/*',
		engine_src_directory..'/renderer/*',
		engine_src_directory..'/rhi/*',
	...
	filter { win_64_platform_filters }
		files { engine_src_directory..'rhi/dx12/*' }
		files { engine_src_directory..'rhi/dx12/*' }
